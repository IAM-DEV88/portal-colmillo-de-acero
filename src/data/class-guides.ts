...
export const classGuidesData: Record<string, ClassGuideData> = {
  "brujo-afliccion-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Caperuza de tejedor de muerte santificada", source: "ICC 25H - Set T10", quality: "epic", id: 51242, icon: "inv_helmet_152" },
      { slot: "Cuello", name: "Amuleto de la elegía silenciosa", source: "ICC 25H - Lady Susurramuerte", quality: "epic", id: 50658, icon: "inv_jewelry_necklace_43" },
      { slot: "Hombros", name: "Hombreras de tejedor de muerte santificadas", source: "ICC 25H - Set T10", quality: "epic", id: 51244, icon: "inv_shoulder_120" },
      { slot: "Espalda", name: "Capa de invierno real", source: "ICC 25H - Barco", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Toga de tejedor de muerte santificada", source: "ICC 25H - Set T10", quality: "epic", id: 51240, icon: "inv_chest_cloth_52" },
      { slot: "Muñeca", name: "Brazales de noche eterna", source: "ICC 25H - Tuétano", quality: "epic", id: 50601, icon: "inv_bracer_37" },
      { slot: "Manos", name: "Guantes de tejedor de muerte santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51241, icon: "inv_gauntlets_82" },
      { slot: "Cintura", name: "Cordón de la reina de sangre", source: "ICC 25H - Reina Lana'thel", quality: "epic", id: 50706, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Pantalones de tejedor de muerte santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51243, icon: "inv_pants_cloth_33" },
      { slot: "Pies", name: "Botas de crecimiento vacilante", source: "ICC 25H - Carapútrea", quality: "epic", id: 50664, icon: "inv_boots_cloth_24" },
      ...
      { slot: "Off-hand", name: "Reloj de sol del anochecer eterno", source: "ICC 25H - Sindragosa", quality: "epic", id: 50719, icon: "inv_offhand_item_04" },
      { slot: "Varita", name: "Varita de pesadilla de seda", source: "ICC 25H - Carapútrea", quality: "epic", id: 50635, icon: "inv_wand_30" }
    ],
    gems: [
  ...
  "chaman-restauracion-335a": {
    ...
    bisItems: [
      ...
      { slot: "Cuello", name: "Gargantilla de alma de fango", source: "ICC 25H - Panzachancro", quality: "epic", id: 50631, icon: "inv_jewelry_necklace_43" },
      ...
      { slot: "Muñeca", name: "Brazales de médico de la Peste", source: "ICC 25H - Panzachancro", quality: "epic", id: 50629, icon: "inv_bracer_37" },
      { slot: "Manos", name: "Guantes de brujo de escarcha santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51246, icon: "inv_gauntlets_82" },
      { slot: "Cintura", name: "Cinturón de forma fracturada", source: "ICC 25H - Panzachancro", quality: "epic", id: 50671, icon: "inv_belt_61" },
      ...
      { slot: "Arma 1H", name: "Cetro de romperreinos", source: "ICC 25H - Lich King", quality: "epic", id: 50734, icon: "inv_mace_116" },
      { slot: "Escudo", name: "Baluarte de acero carmesí", source: "ICC 25H - Barco", quality: "epic", id: 50616, icon: "inv_shield_72" },
  ...
  "druida-equilibrio-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Yelmo de tejeascuas santificado", source: "ICC 25H - Set T10", quality: "epic", id: 51292, icon: "inv_helmet_153" },
      { slot: "Cuello", name: "Amuleto de la elegía silenciosa", source: "ICC 25H - Lady Susurramuerte", quality: "epic", id: 50658, icon: "inv_jewelry_necklace_43" },
      { slot: "Hombros", name: "Manto de tejeascuas santificado", source: "ICC 25H - Set T10", quality: "epic", id: 51294, icon: "inv_shoulder_121" },
      { slot: "Espalda", name: "Capa de invierno real", source: "ICC 25H - Barco", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Vestiduras de tejeascuas santificadas", source: "ICC 25H - Set T10", quality: "epic", id: 51290, icon: "inv_chest_leather_24" },
      { slot: "Muñeca", name: "Brazales de noche eterna", source: "ICC 25H - Tuétano", quality: "epic", id: 50601, icon: "inv_bracer_37" },
      { slot: "Manos", name: "Guantes de tejeascuas santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51291, icon: "inv_gauntlets_83" },
      { slot: "Cintura", name: "Cordón de la reina de sangre", source: "ICC 25H - Reina Lana'thel", quality: "epic", id: 50706, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Pantalones de tejeascuas santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51293, icon: "inv_pants_leather_23" },
      { slot: "Pies", name: "Botas de crecimiento vacilante", source: "ICC 25H - Carapútrea", quality: "epic", id: 50664, icon: "inv_boots_cloth_24" },
      { slot: "Anillo 1", name: "Sortija Cinérea de sabiduría infinita", source: "Reputación Veredicto Cinéreo", quality: "epic", id: 50398, icon: "inv_jewelry_ring_84" },
      { slot: "Anillo 2", name: "Memoria de Malygos", source: "ICC 25H - Sindragosa", quality: "epic", id: 50636, icon: "inv_jewelry_ring_82" },
      { slot: "Abalorio 1", name: "Filacteria del exánime innombrable", source: "ICC 25H - Sindragosa", quality: "epic", id: 50365, icon: "inv_jewelry_trinket_03" },
      { slot: "Abalorio 2", name: "Escama Crepuscular carbonizada", source: "RS 25H - Halion", quality: "epic", id: 54588, icon: "inv_misc_rubysanctum2" },
      { slot: "Arma", name: "Archus, gran bastón de Antonidas", source: "ICC 25H - Lich King", quality: "epic", id: 50731, icon: "inv_staff_104" },
  ...
  "druida-restauracion-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Cubrecabeza de tejeascuas santificado", source: "ICC 25H - Set T10", quality: "epic", id: 51297, icon: "inv_helmet_153" },
      { slot: "Cuello", name: "Amuleto de la elegía silenciosa", source: "ICC 25H - Lady Susurramuerte", quality: "epic", id: 50658, icon: "inv_jewelry_necklace_43" },
      { slot: "Hombros", name: "Manto de tejeascuas santificado", source: "ICC 25H - Set T10", quality: "epic", id: 51299, icon: "inv_shoulder_120" },
      { slot: "Espalda", name: "Capa de invierno real", source: "ICC 25H - Barco", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Vestiduras de tejeascuas santificadas", source: "ICC 25H - Set T10", quality: "epic", id: 51295, icon: "inv_chest_leather_24" },
      { slot: "Muñeca", name: "Brazales de noche eterna", source: "ICC 25H - Tuétano", quality: "epic", id: 50601, icon: "inv_bracer_37" },
      { slot: "Manos", name: "Guantes de tejeascuas santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51296, icon: "inv_gauntlets_82" },
      { slot: "Cintura", name: "Cordón de la reina de sangre", source: "ICC 25H - Reina Lana'thel", quality: "epic", id: 50706, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Pantalones de tejeascuas santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51298, icon: "inv_pants_leather_23" },
      { slot: "Pies", name: "Botas de crecimiento vacilante", source: "ICC 25H - Panzachancro", quality: "epic", id: 50664, icon: "inv_boots_cloth_24" },
      { slot: "Anillo 1", name: "Sortija Cinérea de sabiduría infinita", source: "Reputación Veredicto Cinéreo", quality: "epic", id: 50398, icon: "inv_jewelry_ring_84" },
      { slot: "Anillo 2", name: "Memoria de Malygos", source: "ICC 25H - Sindragosa", quality: "epic", id: 50636, icon: "inv_jewelry_ring_82" },
      { slot: "Abalorio 1", name: "Ábaco de Althor", source: "ICC 25H - Barco", quality: "epic", id: 50359, icon: "inv_jewelry_trinket_02" },
      { slot: "Abalorio 2", name: "Escama Crepuscular resplandeciente", source: "RS 25H - Halion", quality: "epic", id: 54589, icon: "inv_misc_rubysanctum4" },
      { slot: "Arma 1H", name: "Trauma", source: "ICC 25H - Carapútrea", quality: "epic", id: 50605, icon: "inv_mace_115" },
      ...
      { slot: "Ídolo", name: "Ídolo del crecimiento exuberante", source: "Emblemas de Escarcha", quality: "epic", id: 50454, icon: "inv_misc_idol_02" }
    ],
    gems: [
      { type: "meta", name: "Diamante de llama de cielo de ascuas", stat: "+25 Poder con Hechizos y 2% Maná máximo", id: 41401, icon: "inv_misc_gem_diamond_07" },
      { type: "red", name: "Rubí cardeno rúnico", stat: "+23 Poder con Hechizos", id: 40113, icon: "inv_misc_gem_ruby_01" },
  ...
  "guerrero-furia-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Yelmo de señor de Ymirjar santificado", source: "ICC 25H - Set T10", quality: "epic", id: 51227, icon: "inv_helmet_151" },
      { slot: "Cuello", name: "Garra de crueldad de Sindragosa", source: "ICC 25H - Sindragosa", quality: "epic", id: 50633, icon: "inv_jewelry_necklace_43" },
      { slot: "Hombros", name: "Espaldares de señor de Ymirjar santificados", source: "ICC 25H - Set T10", quality: "epic", id: 51229, icon: "inv_shoulder_120" },
      { slot: "Espalda", name: "Capa de invierno real", source: "ICC 25H - Barco", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Coraza de señor de Ymirjar santificada", source: "ICC 25H - Set T10", quality: "epic", id: 51225, icon: "inv_chest_plate_26" },
      { slot: "Muñeca", name: "Brazales de saliva de gárgola", source: "ICC 25H - Lady Susurramuerte", quality: "epic", id: 50611, icon: "inv_bracer_37" },
