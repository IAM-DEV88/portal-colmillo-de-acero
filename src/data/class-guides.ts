...
export const classGuidesData: Record<string, ClassGuideData> = {
  ...
  "chaman-mejora-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Yelmo de brujo de escarcha santificado", source: "Set T10", quality: "epic", id: 51202, icon: "inv_helmet_152" },
      ...
      { slot: "Hombros", name: "Hombreras de brujo de escarcha santificadas", source: "Set T10", quality: "epic", id: 51204, icon: "inv_shoulder_120" },
      { slot: "Espalda", name: "Capa de invierno real", source: "ICC 25H - Barco", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Hábito de brujo de escarcha santificado", source: "Set T10", quality: "epic", id: 51200, icon: "inv_chest_mail_11" },
      ...
      { slot: "Manos", name: "Guantes de brujo de escarcha santificados", source: "Set T10", quality: "epic", id: 51201, icon: "inv_gauntlets_82" },
      { slot: "Cintura", name: "Cincho suturado de Astilla", source: "ICC 25H - Panzachancro", quality: "epic", id: 50620, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Leotardos de brujo de escarcha santificados", source: "Set T10", quality: "epic", id: 51203, icon: "inv_pants_mail_11" },
  ...
  "chaman-restauracion-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Yelmo de brujo de escarcha santificado", source: "Set T10", quality: "epic", id: 51247, icon: "inv_helmet_152" },
      ...
      { slot: "Hombros", name: "Hombreras de brujo de escarcha santificadas", source: "Set T10", quality: "epic", id: 51249, icon: "inv_shoulder_120" },
      { slot: "Espalda", name: "Capa de ocaso ardiente", source: "RS 25H - Halion", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Hábito de brujo de escarcha santificado", source: "Set T10", quality: "epic", id: 51245, icon: "inv_chest_mail_11" },
      ...
      { slot: "Piernas", name: "Leotardos de brujo de escarcha santificados", source: "Set T10", quality: "epic", id: 51248, icon: "inv_pants_mail_11" },
      { slot: "Pies", name: "Botas de científico de la Peste", source: "ICC 25H - Panzachancro", quality: "epic", id: 50664, icon: "inv_boots_cloth_24" },
  ...
  "guerrero-furia-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Casco de señor Ymirjar santificado", source: "Set T10", quality: "epic", id: 51227, icon: "inv_helmet_151" },
      { slot: "Cuello", name: "Colgante de lobreguez", source: "Halion 25H", quality: "epic", id: 50633, icon: "inv_jewelry_necklace_43" },
      { slot: "Hombros", name: "Espaldares de señor Ymirjar santificados", source: "Set T10", quality: "epic", id: 51229, icon: "inv_shoulder_120" },
      ...
      { slot: "Pecho", name: "Coraza de señor Ymirjar santificada", source: "Set T10", quality: "epic", id: 51225, icon: "inv_chest_plate_26" },
      ...
      { slot: "Cintura", name: "Ligas de geliespectro", source: "ICC 25H - Valithria", quality: "epic", id: 50620, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Quijotes de señor Ymirjar santificados", source: "Set T10", quality: "epic", id: 51228, icon: "inv_pants_plate_30" },
      { slot: "Pies", name: "Avanzado del Apocalipsis", source: "Halion 25H", quality: "epic", id: 50639, icon: "inv_boots_plate_12" },
      { slot: "Anillo 1", name: "Sortija Cinérea de venganza infinita", source: "Reputación Veredicto Cinéreo", quality: "epic", id: 50402, icon: "inv_jewelry_ring_84" },
      { slot: "Anillo 2", name: "Anillo de zafiro Razaescarcha", source: "ICC 25H - Valithria", quality: "epic", id: 50644, icon: "inv_jewelry_ring_82" },
      ...
      { slot: "Rango", name: "Fal'inrush, defensora de Quel'thalas", source: "ICC 25H - Lich King", quality: "epic", id: 50733, icon: "inv_weapon_rifle_33" }
    ],
    gems: [
  ...
  "guerrero-proteccion-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Gran yelmo de señor Ymirjar santificado", source: "Set T10", quality: "epic", id: 51222, icon: "inv_helmet_151" },
      { slot: "Cabeza Opcion 2", name: "Protector facial de señor de Ymirjar santificado", source: "Set T10", quality: "epic", id: 51222, icon: "inv_helmet_151" },
      { slot: "Cuello", name: "Medallón con bilis incrustada", source: "ICC 25H - Caraputrea", quality: "epic", id: 50627, icon: "inv_jewelry_necklace_44" },
      { slot: "Cuello Opcion 2", name: "Lazo de malaquita", source: "ICC 25H - Valithria", quality: "epic", id: 50627, icon: "inv_jewelry_necklace_44" },
      { slot: "Hombros", name: "Espaldares de señor Ymirjar santificados", source: "Set T10", quality: "epic", id: 51224, icon: "inv_shoulder_120" },
      { slot: "Espalda", name: "Capa carmesí real", source: "ICC 25H - Consejo de Sangre", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Espalda Opcion 2", name: "Capa de invierno de centinela", source: "Intendente - Dalaran", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Coraza de señor Ymirjar santificada", source: "Set T10", quality: "epic", id: 51220, icon: "inv_chest_plate_26" },
      { slot: "Muñeca", name: "Brazales de juicio oscuro", source: "ICC 25H - Lord Tuétano", quality: "epic", id: 50611, icon: "inv_bracer_37" },
      { slot: "Muñeca Opcion 2", name: "Brazales de saliva de gárgola", source: "ICC 25H - Libramorte", quality: "epic", id: 50611, icon: "inv_bracer_37" },
      { slot: "Manos", name: "Guanteletes de señor Ymirjar santificados", source: "Set T10", quality: "epic", id: 51221, icon: "inv_gauntlets_81" },
      { slot: "Cintura", name: "Cinturón de huesos rotos", source: "ICC 25H - Lord Tuétano", quality: "epic", id: 50613, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Quijotes de señor Ymirjar santificados", source: "Set T10", quality: "epic", id: 51223, icon: "inv_pants_plate_30" },
      { slot: "Piernas Opcion 2", name: "Musleras de esperanza abandonada ", source: "ICC 25H - Lord Tuétano", quality: "epic", id: 51223, icon: "inv_pants_plate_30" },
      { slot: "Pies", name: "Botines de resurrección inminente", source: "Halion 25H", quality: "epic", id: 50607, icon: "inv_boots_plate_12" },
      { slot: "Pies Opcion 2", name: "Grandes botas de calavera sonriente", source: "ICC 25H - Valithria", quality: "epic", id: 50607, icon: "inv_boots_plate_12" },
      { slot: "Anillo 1", name: "Anillo eternamente frío de Devium", source: "ICC 25H - Valithria", quality: "epic", id: 50404, icon: "inv_jewelry_ring_83" },
      { slot: "Anillo 2", name: "Sortija de gigante", source: "ICC 25H - Lady Susurramuerte", quality: "epic", id: 50642, icon: "inv_jewelry_ring_82" },
      { slot: "Abalorio 1", name: "Escama Crepuscular petrificada", source: "Halion 25H", quality: "epic", id: 50344, icon: "inv_misc_organ_03" },
      ...
      { slot: "Arma 1H", name: "Llamada del caos, hoja de los Reyes de Lordaeron", source: "ICC 25H - Lich King", quality: "epic", id: 50738, icon: "inv_mace_116" },
      { slot: "Arma 1H Opcion 2", name: "Mithrios, legado de Barbabronce", source: "ICC 25H - Lich King", quality: "epic", id: 50738, icon: "inv_mace_116" },
  ...
  "paladin-proteccion-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Casco juraluz santificado", source: "Set T10", quality: "epic", id: 51267, icon: "inv_helmet_154" },
      ...
      { slot: "Hombros", name: "Hombreras de placas juraluz santificadas", source: "Set T10", quality: "epic", id: 51269, icon: "inv_shoulder_121" },
      { slot: "Espalda", name: "Capa de invierno real", source: "ICC 25H - Barco", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Placa de batalla juraluz santificada", source: "Set T10", quality: "epic", id: 51265, icon: "inv_chest_plate_27" },
      { slot: "Muñeca", name: "Brazales de saliva de gárgola", source: "ICC 25H - Lady Susurramuerte", quality: "epic", id: 50611, icon: "inv_bracer_37" },
      { slot: "Manos", name: "Guanteletes juraluz santificados", source: "Set T10", quality: "epic", id: 51266, icon: "inv_gauntlets_84" },
      { slot: "Cintura", name: "Cinturón de huesos rotos", source: "ICC 25H - Tuétano", quality: "epic", id: 50613, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Quijotes juraluz santificados", source: "Set T10", quality: "epic", id: 51268, icon: "inv_pants_plate_31" },
  ...
  "paladin-retribucion-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Casco juraluz santificado", source: "Set T10", quality: "epic", id: 51277, icon: "inv_helmet_154" },
      { slot: "Cuello", name: "Penacho de Penumbra", source: "RS 25H - Halion", quality: "epic", id: 54581, icon: "item_icecrownnecka" },
      { slot: "Hombros", name: "Hombreras de placas juraluz santificadas", source: "Set T10", quality: "epic", id: 51279, icon: "inv_shoulder_121" },
      { slot: "Espalda", name: "Capa de ocaso desgarrada", source: "RS 25H - Halion", quality: "epic", id: 54583, icon: "item_icecrowncloakd" },
      { slot: "Pecho", name: "Placa de batalla juraluz santificada", source: "Set T10", quality: "epic", id: 51275, icon: "inv_chest_plate_27" },
      ...
      { slot: "Cintura", name: "Cincho suturado de Astilla", source: "ICC 25H - Panzachancro", quality: "epic", id: 50620, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Quijotes juraluz santificados", source: "Set T10", quality: "epic", id: 51278, icon: "inv_pants_plate_31" },
  ...
  "picaro-combate-335a": {
    ...
    bisItems: [
      { slot: "Cabeza", name: "Caperuza de hoja de las sombras santificada", source: "Set T10", quality: "epic", id: 51252, icon: "inv_helmet_153" },
      { slot: "Cuello", name: "Garra de crueldad de Sindragosa", source: "ICC 25H - Sindragosa", quality: "epic", id: 50633, icon: "inv_jewelry_necklace_43" },
      { slot: "Hombros", name: "Hombreras de hoja de las sombras santificadas", source: "Set T10", quality: "epic", id: 51254, icon: "inv_shoulder_121" },
      { slot: "Espalda", name: "Capa de invierno real", source: "ICC 25H - Barco", quality: "epic", id: 50628, icon: "item_icecrowncloakb" },
      { slot: "Pecho", name: "Coraza de hoja de las sombras santificada", source: "Set T10", quality: "epic", id: 51250, icon: "inv_chest_leather_24" },
      { slot: "Muñeca", name: "Brazales de saliva de gárgola", source: "ICC 25H - Lady Susurramuerte", quality: "epic", id: 50611, icon: "inv_bracer_37" },
      { slot: "Manos", name: "Guantes de secretos de Aldriana", source: "ICC 25H - Carapútrea", quality: "epic", id: 51251, icon: "inv_gauntlets_83" },
      { slot: "Cintura", name: "Cincho suturado de Astilla", source: "ICC 25H - Panzachancro", quality: "epic", id: 50620, icon: "inv_belt_61" },
      { slot: "Piernas", name: "Quijotes de hoja de las sombras santificados", source: "Set T10", quality: "epic", id: 51253, icon: "inv_pants_leather_23" },
