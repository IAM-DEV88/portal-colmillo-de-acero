...
// Definir el tipo para los datos del roster
interface RosterData {
  members: RosterMember[];
  classInfo: Record<string, RosterClassInfo>;
  ranks: string[];
  classes: string[];
  totalMembers: number;
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const classFilter = document.getElementById('class-filter') as HTMLSelectElement | null;
  const rankFilter = document.getElementById('rank-filter') as HTMLSelectElement | null;
  const tableBody = document.getElementById('roster-table-body') as HTMLTableSectionElement | null;
  ...
  function sortMembers(key: keyof RosterMember) {
