document.addEventListener('DOMContentLoaded', () => {
    ...
    function filterMembers() {
        ...
        const selectedClass = (classFilter === null || classFilter === void 0 ? void 0 : classFilter.value) || 'all';
        const selectedRank = (rankFilter === null || rankFilter === void 0 ? void 0 : rankFilter.value) || 'all';
